    ...
    return(
        <div className = "footer">
            ...
            <a target = "_blank" href = "https://twitter.com/the-izuchukwu">
                <i className="fa-brands fa-twitter"  style={twitterIconStyle}  onMouseEnter={handleMouseEnterTwitter} onMouseLeave={handleMouseLeaveTwitter}></i>
            </a>
            </div>

            <div className="contact-footer github">
                <a target = "_blank" href="https://github.com/izuchukwumba">
                    <i className="fa-brands fa-github" style={githubIconStyle}  onMouseEnter={handleMouseEnterGithub} onMouseLeave={handleMouseLeaveGithub}></i>
                </a>
            </div>

            <div className="contact-footer email">
                <a href = "mailto:izuchukwumba100@gmail.com">
                <i className="fa-solid fa-envelope" style={emailIconStyle}  onMouseEnter={handleMouseEnterEmail} onMouseLeave={handleMouseLeaveEmail}></i>
                </a> 
                </div>
        </div>
    )
